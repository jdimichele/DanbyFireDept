<template>
  <div>
      ...
      <div class="flex-none">
        <div class="menu menu-horizontal p-0">
          ...
          <div class="px-1">
            ...
            <ul :class="{ isOpen }">
              <span>
                <li><router-link to="/volunteer/roles">Roles</router-link></li>
                <li><router-link to="/volunteer/join">Join</router-link></li>
              </span>
            </ul>
          </div>
          |
    ...
    <footer>
      ...
      <div class="py-2 text-danby-yellow text-center">© DVFC 2022</div>
    </footer>
  </div>
</template>
