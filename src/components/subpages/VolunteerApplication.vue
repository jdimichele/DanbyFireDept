<template>
  <h3 class="text-center py-3">
    We are continuously looking for more volunteers and nearly every volunteer joins with no prior
    emergency qualifications or experience; all training and equipment is provided at no cost to the
    volunteer.
  </h3>
  ...
  <div class="pb-5 pl-5">
    <p>
      If you're interested in volunteering and joining our fire company, please fill out the form
      below:
    </p>
  </div>
  ...
  methods: {
    async submitApplication() {
      try {
        ...
        const response = await this.$store.dispatch('submitApplication', applicationForm)
