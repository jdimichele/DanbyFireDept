<template>
  <div class="grid grid-cols-1 sm:grid-cols-2">
    <div>
      ...
      <ul class="pb-10 ml-10 list-disc list-inside">
        <li v-for="tompkinsLink in tompkinsLinks" :key="tompkinsLink.id">
          <a :href="tompkinsLink.url" target="_blank" class="hover:underline hover:text-blue-700">
            {{ tompkinsLink.name }}
          </a>
        </li>
      </ul>
    ...
    <div>
      ...
      <ul class="pb-10 ml-10 list-disc list-inside">
        <li v-for="otherFireLink in otherFireLinks" :key="otherFireLink.id">
          <a :href="otherFireLink.url" target="_blank" class="hover:underline hover:text-blue-700">
            {{ otherFireLink.name }}
          </a>
        </li>
      </ul>
    ...
    <div>
      ...
      <ul class="pb-10 ml-10 list-disc list-inside">
        <li v-for="emergencyMedicalLink in emergencyMedicalLinks" :key="emergencyMedicalLink.id">
          <a
    ...
    <div>
      ...
      <ul class="pb-10 ml-10 list-disc list-inside">
        <li v-for="lawEnfLink in lawEnfLinks" :key="lawEnfLink.id">
          <a :href="lawEnfLink.url" target="_blank" class="hover:underline hover:text-blue-700">
            {{ lawEnfLink.name }}
          </a>
        </li>
      </ul>
    ...
    <div>
      <h2 class="font-bold flex-grow border-b-2 ml-5 mr-10 border-danby-red">Local Government</h2>
      <ul class="pb-10 ml-10 list-disc list-inside">
        <li v-for="localGovLink in localGovLinks" :key="localGovLink.id">
          <a :href="localGovLink.url" target="_blank" class="hover:underline hover:text-blue-700">
            {{ localGovLink.name }}
          </a>
        </li>
      </ul>
    ...
    <div>
      ...
      <ul class="pb-10 ml-10 list-disc list-inside">
        <li v-for="localServsLink in localServsLinks" :key="localServsLink.id">
          <a :href="localServsLink.url" target="_blank" class="hover:underline hover:text-blue-700">
            {{ localServsLink.name }}
          </a>
        </li>
      </ul>
